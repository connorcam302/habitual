...
const zh: Record<string, string> = {
  ...
  'Create your account': '创建你的账户', 'Set up your private profile after creating your account.': '创建账户后，设置你的私人个人资料。',
  'Account action': '账户操作', 'Already have an account? Sign in': '已有账户？登录', 'New here? Create account': '新用户？创建账户',
  'Show sign in form': '显示登录表单', 'Show create account form': '显示创建账户表单',
  ...
  'Fill in what you know now. The planner only needs the marked basics to start, and you can refine everything later.': '先填写你现在知道的内容。计划只需要标出的基础信息即可开始，之后可以继续完善。',
  'Required to start': '开始前必填', 'One goal': '一个目标', 'One activity': '一个活动', 'Availability or commitment': '可用时间或固定活动',
  'For example, move more consistently': '例如，更稳定地活动',
  'Walk, piano, Pilates…': '散步、钢琴、普拉提…',
  'Anything the planner should consider': '计划需要考虑的事项',
  'Mat, bike, piano…': '垫子、自行车、钢琴…', 'Anything to work around': '需要避开的限制',
  'Anything you do not want suggested': '不想被建议的活动', 'Context, preferences, or planning notes': '背景、偏好或计划备注',
  'Start planning': '开始规划',
